...
public class projectListAdapter extends RecyclerView.Adapter<projectListAdapter.MyViewHolder> {
    ...
    public projectListAdapter(Context context, ArrayList<Projects> projectList) {
    ...
    private void deleteProjectFromFirebase(String projectID) {
        ...
        Query query = projectRef.child("ProjectInfo").orderByChild("projectID").equalTo(projectID);
        ...
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (key != null) {
                        updateLog(key);
                        projectRef.child("ProjectInfo").child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
    ...
    private void updateLog(String key) {
        ...
        DatabaseReference fromPath = FirebaseDatabase.getInstance().getReference().child("Projects").child("ProjectInfo").child(key);
    ...
    private void showDialog(String projectID) {
        ...
        Button create_project, addProject;
        ...
        pr_city.setHintTextColor(Color.RED);
        pr_city.setEnabled(false);
        ...
        create_project.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateProjectFromFirebase(projectID, projectName);
                alertDialog.dismiss();
            }
        });
    ...
    private void updateProjectFromFirebase(String projectID, String projectName) {
        Query query = projectRef.child("ProjectInfo").orderByChild("projectID").equalTo(projectID);
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (key != null) {
                        if (!projectName.isEmpty()) {
                            ...
                            projectRef.child("ProjectInfo").child(key).updateChildren(updates).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
